...
<body>
    ...
    <div id="sidebar">
        ...
        <div>
            <div class="categorias" id="geral"> <img src="../images/brain.png" id="brain"> <p>Público</p></div>
            <div class="categorias" id="nutri"> <img src="../images/cobra.png"> <p>Nutrição</p> </div>
            <div class="categorias" id="adm"> <img src="../images/excel.png"> <p>Administração</p> </div>
            <div class="categorias" id="ds"> <img src="../images/computador.png"> <p>Desenvolvimento de Sistemas</p> </div>
            <div class="categorias" id="anonim"> <img src="../images/anonimo.png"> <p>Anônimo</p> </div>
        </div>
    </div>
    ...
    <div id="publicacoes">
        <?php
            ...
            if($tipo == 2){
                echo "<script> window.location.href = '../php/anonimos.php'</script>"; 
            }
            $id = $_SESSION['user'];
            $pensamento->carregarPostagens($id,$tipo);
            //vou te chamar na origem dela ok
        ?>
    </div>
